...
from USERAPP.models import CustomerModel
...
class ProductModel(models.Model):
    ...
    productImage = models.ImageField(verbose_name="Ürün Görseli",upload_to="media/")
...
class AddressModel(models.Model):
    customer     = models.ForeignKey(CustomerModel, on_delete=models.CASCADE, verbose_name="Müşteri")
...
class OrderModel(models.Model):
    customer        = models.ForeignKey(CustomerModel, on_delete=models.SET_NULL, blank=True, null=True,verbose_name="Müşteri")
